    ...
    <>
      <nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "bg-zinc/90 backdrop-blur-md border-b border-obsidian py-3 translate-y-0 opacity-100 visible"
            : "bg-transparent py-5 -translate-y-full opacity-0 pointer-events-none invisible"
        }`}
      >
