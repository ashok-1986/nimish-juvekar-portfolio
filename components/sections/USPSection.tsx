    ...
    const init = async () => {
      ...
      ctx = gsap.context(() => {
        ...
        cards?.forEach((card, i) => {
          gsap!.fromTo(card,
            { y: 40, opacity: 0, rotateX: 8, transformPerspective: 800 },
            {
    ...
    >
      ...
      <div className="container relative z-10">
        <div className="usp-heading mb-14" style={{ opacity: 0 }}>
          ...
          <blockquote className="text-lg italic max-w-2xl mx-auto leading-relaxed" style={{ color: 'rgba(255,255,255,0.75)' }}>
            {PERSONAL.quote}
          </blockquote>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {USP_CARDS.map((card, i) => {
            ...
            return (
              <div
                key={i}
                className="usp-card group rounded-2xl p-6 relative overflow-hidden"
                style={{
                  opacity: 0,
