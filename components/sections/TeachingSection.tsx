    ...
    >
      <div className="container relative z-10">
        ...
        <div className="teach-heading mb-10 md:mb-14" style={{ opacity: 0 }}>
          ...
          <h2 className="font-serif font-bold text-obsidian heading-underline" style={{ fontSize: 'clamp(28px, 4vw, 52px)' }}>
            Teaching at UEL
          </h2>
          <p className="font-sans text-[15px] text-muted mt-4 md:mt-6 max-w-xl mx-auto italic">
            {TEACHING.philosophy}
          </p>
        </div>
          ...
          {TEACHING.modules.map((mod, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                <span className="font-sans text-[10px] font-600 uppercase tracking-widest text-tangerine">
                  {mod.level}
                </span>
                <h3 className="font-serif text-[17px] font-bold text-obsidian mt-2 mb-3 group-hover:text-tangerine transition-colors duration-200">
                  {mod.name}
                </h3>
                {mod.score && (
                  <div
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-sans font-600 text-[13px] uppercase tracking-widest text-obsidian">
              2025 Professional Development
            </h3>
          </div>
          ...
          <div className="training-grid flex flex-wrap gap-2 md:gap-3">
            {TEACHING.uelTraining2025.map((item, i) => {
              ...
              return (
                ...
                >
                  <CheckCircle size={12} className="text-tangerine" style={{ flexShrink: 0 }} />
                  <span className="font-sans text-[11px] md:text-[12px] text-muted">{label}</span>
                  {hasScore && scoreMatch && (
                    <span
